#!/bin/bash
#SBATCH --job-name=mvpa_valbins_delay
#SBATCH --output=/oak/stanford/groups/russpold/users/buckholtz/DD_Kable/scripts/dd-kable-analysis/logs/mvpa_valbins_delay_%A_%a.out
#SBATCH --error=/oak/stanford/groups/russpold/users/buckholtz/DD_Kable/scripts/dd-kable-analysis/logs/mvpa_valbins_delay_%A_%a.err
#SBATCH --time=8:00:00
#SBATCH --mem=64G
