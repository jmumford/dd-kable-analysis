#!/bin/bash
#SBATCH --job-name=mvpa_pauli_rois
#SBATCH --output=/oak/stanford/groups/russpold/users/buckholtz/DD_Kable/scripts/dd-kable-analysis/logs/mvpa_pauli_rois_%A_%a.out
#SBATCH --error=/oak/stanford/groups/russpold/users/buckholtz/DD_Kable/scripts/dd-kable-analysis/logs/mvpa_pauli_rois_%A_%a.err
#SBATCH --time=4:00:00
#SBATCH --mem=16G
